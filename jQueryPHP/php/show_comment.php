<?php
	...
	$_sql = mysql_query("SELECT COUNT(*) AS count FROM jqcomment WHERE titleid='{$_POST['titleid']}'");
	...
	$query = mysql_query("SELECT ({$_count}) AS count,titleid,comment,user,date FROM jqcomment 
